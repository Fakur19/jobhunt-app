...
import { LogIn, Sparkles, Briefcase, FileText, Target } from 'lucide-react';
      ...
      <div className="h-screen w-full flex bg-white overflow-hidden">
        ...
        <div className="flex-1 flex flex-col justify-center px-12 lg:px-24 bg-slate-50 relative">
          ...
          <div className="max-w-xl">
            ...
            <Button onClick={handleLogin} size="lg" className="h-14 px-8 text-lg gap-3 bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-200">
